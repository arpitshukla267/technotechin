        ...
        >
          ...
          <div className="pt-10 border-t border-[#2a2a2a] w-full flex flex-wrap items-center justify-center gap-8 text-xs text-[#888888]">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono">{STUDIO_CONTACT.email}</span>
            </div>
            <div className="flex items-start gap-2 max-w-xs text-center sm:text-left">
              <MapPin className="w-3.5 h-3.5 text-[#666666] shrink-0 mt-0.5" />
              <span>{STUDIO_CONTACT.addressLines.join(', ')}</span>
            </div>
            <div className="flex items-center gap-2">
